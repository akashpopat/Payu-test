...
public class MainActivity extends AppCompatActivity {
    ...
    // Store one click card
    int storeOneClickHash = 1;
    String key;
    // store cards
    private String var1 = "2";
    String salt = null;
    ...
    public void testRun(View view) {
        ...
        mPaymentParams.setKey(((EditText)findViewById(R.id.keyEditText)).getText().toString());
        key = ((EditText)findViewById(R.id.keyEditText)).getText().toString();
        mPaymentParams.setAmount(((EditText)findViewById(R.id.amountEditText)).getText().toString());
        mPaymentParams.setProductInfo(((EditText)findViewById(R.id.productInfoEditText)).getText().toString());
        mPaymentParams.setFirstName(((EditText)findViewById(R.id.firstNameEditText)).getText().toString());
        mPaymentParams.setEmail(((EditText)findViewById(R.id.emailEditText)).getText().toString());
        mPaymentParams.setTxnId(((EditText)findViewById(R.id.txnidEditText)).getText().toString());
        mPaymentParams.setSurl(((EditText)findViewById(R.id.surlEditText)).getText().toString());
        mPaymentParams.setFurl(((EditText)findViewById(R.id.furlEditText)).getText().toString());
        mPaymentParams.setUdf1("udf1");
        mPaymentParams.setUdf2("udf2");
        mPaymentParams.setUdf3("udf3");
        mPaymentParams.setUdf4("udf4");
        mPaymentParams.setUdf5("udf5");
        mPaymentParams.setUserCredentials(((EditText)findViewById(R.id.uniqueUserCredEditText)).getText().toString());
...
//        nextButton.setEnabled(false); // lets not allow the user to click the button again and again.
        ...
        // Only test
        try{
            payuConfig.setEnvironment(Integer.parseInt("2"));
        }catch (Exception e){
